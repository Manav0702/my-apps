    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buy1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Chocolate.this, "Your Choice Is Amazing", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(getBaseContext(),SummaryActivity.class);
                intent.putExtra("keyname",name);
                intent.putExtra("keyprice",price);
                intent.putExtra("resId", R.drawable.p1);
        ...
        buy2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("keyname",name);
                intent.putExtra("keyprice",price);
                intent.putExtra("resId", R.drawable.p2);
        ...
        buy3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("keyname",name);
                intent.putExtra("keyprice",price);
                intent.putExtra("resId", R.drawable.p3);
